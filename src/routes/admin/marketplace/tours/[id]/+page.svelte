	...
	<section class="card p-4">
		...
		<div class="flex flex-wrap items-center gap-2">
			...
			<!-- Featured is the marketplace's own editorial slot, not a lifecycle step, so it
			     ...
			     Operator verification is NOT here: it is a claim about the company, so
			     it belongs on the tenant's own page, not on whichever listing an admin
			     happened to have open. See /admin/tenants/[id]. -->
